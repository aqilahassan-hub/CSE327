    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                doctor.setName(name.getBytes().toString().trim());
                doctor.setEmail(email);
                doctor.setPassword(password);
                doctor.setPhone(contact);
                // reff.push().setValue(user);
                Toast.makeText(DoctorRegister.this,"data Inserted",Toast.LENGTH_LONG).show();
                ...
                if(!TextUtils.isEmpty(email) && !TextUtils.isEmpty(password) && !TextUtils.isEmpty(name)&& !TextUtils.isEmpty(age)&& !TextUtils.isEmpty(contact)&&
                            ...
                            .addOnCompleteListener(DoctorRegister.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if (task.isSuccessful()) {
                                        ...
                                        userDetails.put("Fees", bloodgroup);
                                        userDetails.put("Contact_N0", contact);
                                        userDetails.put("Specialised", address);
                                        ...
                                        mUserDetails.child("Doctor_Details").child(uid).setValue(userDetails).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                //if (task.isSuccessful()) {
                                                Toast.makeText(DoctorRegister.this, "Account Successfully Created", Toast.LENGTH_SHORT).show();
                                                Intent main_Intent = new Intent(DoctorRegister.this, MainActivity.class);
                                    ...
                                    {
                                        mRegProgress.hide();
                                        Toast.makeText(DoctorRegister.this, "Creating Account Failed", Toast.LENGTH_LONG).show();
                                    }
                    ...
                    Toast.makeText(DoctorRegister.this,"Please fill all field",Toast.LENGTH_LONG).show();
